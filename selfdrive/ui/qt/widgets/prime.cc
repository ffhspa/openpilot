...
SetupWidget::SetupWidget(QWidget* parent) : QFrame(parent) {
  ...
  QLabel* registrationTitle = new QLabel("");
  ...
  QPushButton* pair = new QPushButton("");
